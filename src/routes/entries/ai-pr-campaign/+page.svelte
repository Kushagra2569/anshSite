            ...
            <div class="w-screen mx-auto px-4 flex flex-col items-center">
                ...
                <Card sizeClass="w-5/6">
                    <div class="card-body">
                        ...
                        {#if data.Role}
                            <h3 class="text-xl font-bold text-accent mt-6 mb-3">{data.Role.title}</h3>
                            <p class="whitespace-pre-line mb-6">{data.Role.description}</p>
                        {/if}

                        {#if data.Impact}
                            <h3 class="text-xl font-bold text-accent mt-6 mb-3">Impact</h3>
                            {#each data.Impact as impact}
                                <div class="mb-4">
                                    <h4 class="font-medium text-accent">{impact.title}</h4>
                        ...
                        {#if data.sustainingMomentum}
                            <h3 class="text-xl font-bold text-accent mt-6 mb-3">Sustaining Momentum</h3>
